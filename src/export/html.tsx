...
.doc-h1 { font-size: 1.76em; font-weight: 600; letter-spacing: -0.01em; margin: 0 0 6pt; text-align: center; line-height: 1.2; }
.doc-h2 { font-size: 1.2em; font-weight: 600; margin: 18pt 0 6pt; }
.doc-h3 { font-size: 0.96em; font-weight: 600; margin: 14pt 0 4pt; text-transform: uppercase; letter-spacing: 0.06em; color: #555; }
...
.doc-cover .dateline { margin-top: 28pt; font-family: 'Geist Mono', monospace; font-size: 0.8em; letter-spacing: 0.06em; color: #555; }
.doc-cover .ornament { width: 0.6in; border-top: 0.75pt solid #999; margin: 6pt 0; }
.doc-schedule { width: 100%; border-collapse: collapse; margin: 8pt 0 12pt; font-size: 0.88em; }
...
.doc-schedule td.num { font-family: 'Geist Mono', monospace; font-size: 0.8em; color: #777; width: 0.4in; padding-top: 9pt; }
...
.doc-verse-ref { font-weight: 600; font-size: 0.92em; margin: 8pt 0 2pt; }
.doc-verse { display: grid; grid-template-columns: 16pt 1fr; gap: 4pt; margin: 1pt 0; }
.doc-verse .vnum { text-align: right; font-size: 0.72em; color: #777; padding-top: 3pt; }
.doc-notes-title { font-weight: 600; font-size: 0.96em; margin: 14pt 0 8pt; }
.doc-notes-line { border-bottom: 0.5pt solid #c8c2b6; height: 22pt; }
.doc-song-title { font-weight: 600; font-size: 1.04em; margin: 14pt 0 8pt; }
